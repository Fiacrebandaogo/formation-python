...
Le formateur vous a transmis un fichier compressé nommé
\fichier{\textbf{formation\_python.zip}}. Il contient votre dossier de travail et
les programmes qui configureront Python.

\begin{enumerate}
\item \textbf{Téléchargez \fichier{formation\_python.zip}}.
\item \textbf{Décompressez-le} dans un emplacement de votre choix sur votre
      ordinateur : clic droit sur le fichier \fleche\textbf{Extraire tout} (Windows) ou
      double-clic (Mac). \\ Vous devez avoir un dossier nommé \fichier{\textbf{formation\_python}}
...
Un seul fichier à retenir, et c'est celui que vous rouvrirez à chaque séance. Au
premier lancement, il installe tous les outils avant d'ouvrir un éditeur de
code appelé ``JupyterLab''.
